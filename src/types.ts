...
type CSSNestedSelectors<Aliases, BreakpointKeys extends string> = {
  [key in `& ${string}` | `&:${string}`]: CSSPropsWithoutGlobal<
    Aliases,
    BreakpointKeys
  >;
};
...
export type CSSValueWithoutBreakpoint<Aliases> = {
  [Property in keyof (CSSProperties & Aliases)]?: (CSSProperties &
    Aliases)[Property];
};

type CSSValue<Aliases, BreakpointKeys extends string> = {
  [Property in keyof (CSSProperties & Aliases)]?:
    | (CSSProperties & Aliases)[Property]
    | BreakpointTypes<BreakpointKeys, (CSSProperties & Aliases)[Property]>;
};

export type CSSPropsWithoutGlobal<Aliases, BreakpointKeys extends string> =
  | CSSValue<Aliases, BreakpointKeys>
  | KeyframesCSS<Aliases>
  | MediaCSS<Aliases, BreakpointKeys>
  | CSSNestedSelectors<Aliases, BreakpointKeys>
  | CSSNestedSelectorsWithoutChild<Aliases, BreakpointKeys>;
export type CSSProps<Aliases, BreakpointKeys extends string> =
  | GlobalCSS<Aliases, BreakpointKeys>
  | CSSPropsWithoutGlobal<Aliases, BreakpointKeys>;
export type AliasFn<Aliases> = (
  value: any,
) => CSSValueWithoutBreakpoint<Aliases>;
...
export interface CSSOptionProps<Aliases, BreakpointKeys extends string> {
  ...
  getValue?: (
    value: string | number,
    prop: string,
    css: CSSProps<Aliases, BreakpointKeys>,
    dept: number,
  ) => string | number;
  getProps?: (
    prop: string,
    ...
    css: CSSProps<Aliases, BreakpointKeys>,
    dept: number,
  ) => CSSProps<Aliases, BreakpointKeys> | void;
}
